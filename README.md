...
## Creates a ROS2 /vocalize topic that you can publish string data to. String data will be converted TTS and vocalized.
...
BAD	p315	18 	F	American, New, England, (Text and mic2 files unavailable)
